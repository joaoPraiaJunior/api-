...
import med.voll.api.model.entity.paciente.DetalhamentoPaciente;
...
public class PacienteController {
    ...
    ResponseEntity<String> atualizar(@Valid @RequestBody DadosAtualizaPaciente dados) {
        try {
            ...
            return ResponseEntity.ok("Paciente atualizado com sucesso", new DetalhamentoPaciente(paciente));
        } catch (Exception e) {
